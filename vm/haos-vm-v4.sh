...
DEV=$(curl -s https://raw.githubusercontent.com/home-assistant/version/ea4442ad8923086c5ecbbcd6fd93adfb64b93f6c/stable.json | grep "ova" | awk '{print substr($2, 2, length($2)-3) }')
