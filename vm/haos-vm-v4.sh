...
DEV=$(curl -s https://raw.githubusercontent.com/home-assistant/version/07ee1317a0153d56ef55f78a44141c546792ed23/stable.json | grep "ova" | awk '{print substr($2, 2, length($2)-3) }')
